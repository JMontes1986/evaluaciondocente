  ...
  return (
    <div className="mx-auto max-w-5xl">
      <PageHeading
        eyebrow="Sistema"
        title="Configuración"
        description="Administra los parámetros operativos y de confidencialidad de la plataforma."
      />
      ...
      <form action={updateSystemSettingsAction} className="rounded-xl border bg-card">
        <div className="border-b p-5 sm:p-6">
          ...
          <div className="mt-5 max-w-sm">
            <label htmlFor="min-responses" className="mb-2 block text-sm font-semibold">
            ...
            <Input
              ...
              max={50}
              required
              defaultValue={settings.minResponses}
            />
        ...
        <div className="border-b p-5 sm:p-6">
          ...
          <div className="mt-5 max-w-sm">
            <label htmlFor="session-minutes" className="mb-2 block text-sm font-semibold">
              Duración en minutos
            </label>
            <Input
              id="session-minutes"
              name="studentSessionMinutes"
              type="number"
              min={15}
              max={1440}
              required
              defaultValue={settings.studentSessionMinutes}
            />
