...
export function moduleForPathname(pathname: string): AdminModuleKey | "super_admin" | null {
  ...
  if (pathname.startsWith("/administracion/usuarios") || pathname.startsWith("/administracion/configuracion") || pathname.startsWith("/administracion/logs") || pathname.startsWith("/administracion/seguridad")) {
    return "super_admin";
  }
